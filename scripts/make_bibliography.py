...
listed explicitly below; volume/issue/pages were verified against publisher
records (OUP, Wiley, ACP, Econometric Society, Project Euclid) on 21 Jul 2026.
...
# Classical statistics references (not on arXiv). Verified against publisher
# records on 21 Jul 2026 (OUP, Wiley, ACP, Econometric Society, Project
# Euclid): volume, issue, and pages all confirmed. DOIs included where the
# publisher page stated them; Tan (2006) is cited without a DOI rather than
# guessing one.
CLASSICS = r"""
